//
//  NMPublicPlaneConnectionDetailsViewController.m
//  NeverMissed
//
...
@implementation NMPublicPlaneConnectionDetailsViewController

- (void)viewDidLoad {
    [_postedByDescriptionLabel sizeToFit];
    [_lookingFordescriptionLabel sizeToFit];
    
    NSString *carrier = [self.connection objectForKey:@"carrier"];
    NSString *flightNo = [self.connection objectForKey:@"flightNo"];
    _planeLabel.text = [NSString stringWithFormat:@"%@ flight no. %@", carrier, flightNo];
