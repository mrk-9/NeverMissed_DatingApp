//
//  NMPublicLocationConnectionDetailsViewController.m
//  NeverMissed
//
...
@implementation NMPublicLocationConnectionDetailsViewController
- (void)viewDidLoad {
    [_postedByDescriptionLabel sizeToFit];
    [_lookingFordescriptionLabel sizeToFit];
    
    PFGeoPoint *connectionLocationGeoPoint = [_connection objectForKey:@"location"];
    CLLocationCoordinate2D startCoord = CLLocationCoordinate2DMake(connectionLocationGeoPoint.latitude, connectionLocationGeoPoint.longitude);
